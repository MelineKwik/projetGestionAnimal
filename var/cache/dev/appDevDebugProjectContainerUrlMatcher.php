    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/a')) {
            ...
            if (0 === strpos($pathinfo, '/ajoutUtilisateur')) {
                // ajoutUtilisateurAdmin
                if ('/ajoutUtilisateurAdmin' === $pathinfo) {
                    return array (  '_controller' => 'AppBundle\\Controller\\Ek_AjouterController::ajouterAdminAction',  '_route' => 'ajoutUtilisateurAdmin',);
                }

                // ajoutUtilisateurFamille
                if ('/ajoutUtilisateurFamille' === $pathinfo) {
                    return array (  '_controller' => 'AppBundle\\Controller\\Ek_AjouterController::ajouterFamilleAction',  '_route' => 'ajoutUtilisateurFamille',);
                }

                // ajoutUtilisateurVeterinaire
                if ('/ajoutUtilisateurVeterinaire' === $pathinfo) {
                    return array (  '_controller' => 'AppBundle\\Controller\\Ek_AjouterController::ajouterVeterinaireAction',  '_route' => 'ajoutUtilisateurVeterinaire',);
                }

                // ajoutUtilisateurTransporteur
                if ('/ajoutUtilisateurTransporteur' === $pathinfo) {
                    return array (  '_controller' => 'AppBundle\\Controller\\Ek_AjouterController::ajouterTransporteurAction',  '_route' => 'ajoutUtilisateurTransporteur',);
                }
        ...
        // dashboard
        if ('' === $trimmedPathinfo) {
            $ret = array (  '_controller' => 'AppBundle\\Controller\\Ek_AffichageController::dashboardAction',  '_route' => 'dashboard',);
            if ('/' === substr($pathinfo, -1)) {
                // no-op
            } elseif ('GET' !== $canonicalMethod) {
                goto not_dashboard;
        ...
        if (0 === strpos($pathinfo, '/supprimerUtilisateur') && preg_match('#^/supprimerUtilisateur/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'supprimerUtilisateur')), array (  '_controller' => 'AppBundle\\Controller\\Ek_SupprimerController::supprimerUtilisateurAction',));
        }
