...
class Ek_Animal
{
    ...
    /**
     *
     * @ORM\ManyToOne(targetEntity="Ek_Espece", inversedBy="espece")
     * @ORM\JoinColumn(name="id_espece", referencedColumnName="id")
     */
    private $espece;
    
     /**
     * @ORM\OneToMany(targetEntity="Ek_Evenement", mappedBy="evenement")
     */
    private $evenement;
    
     /**
     *
     * @ORM\ManyToOne(targetEntity="Ek_Personne", inversedBy="animal")
